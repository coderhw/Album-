...
@interface HHPhotoPickerViewController ()<DZNEmptyDataSetSource, DZNEmptyDataSetDelegate>

/// 所有相册数据
@property (nonatomic, strong) NSArray<HHAlbumCollectionModel *> *albums;

@end

@implementation HHPhotoPickerViewController
...
- (void)tableView:(UITableView *)tableView willDisplayCell:(UITableViewCell *)cell forRowAtIndexPath:(NSIndexPath *)indexPath {
    HHAlbumCollectionModel *album = self.albums[indexPath.row];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    HHPhotoCollectionViewController *vc = [[HHPhotoCollectionViewController alloc] init];
...
- (void)loadAssetsCollection {
    ...
    [PHPhotoLibrary requestAuthorization:^(PHAuthorizationStatus status) {
        ...
        NSMutableArray<HHAlbumCollectionModel *> *array = [NSMutableArray array];
        // 获取所有系统的相册
        ...
        for (PHAssetCollection *collection in smartResult) {
            HHAlbumCollectionModel *album = [[HHAlbumCollectionModel alloc] init];
