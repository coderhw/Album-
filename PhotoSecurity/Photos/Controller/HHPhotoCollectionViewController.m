//
//  HHPhotoCollectionViewController.m
//  PhotoSecurity
//
...
#import "HHPhotoCollectionViewController.h"
#import "HHPhotoCollectionViewCell.h"
#import "HHAlbumCollectionModel.h"
#import <DZNEmptyDataSet/UIScrollView+EmptyDataSet.h>

@interface HHPhotoCollectionViewController ()<DZNEmptyDataSetSource, XPPhotoCollectionViewCellDelegate>
...
@implementation HHPhotoCollectionViewController
...
- (void)viewDidLoad {
    ...
    [self.collectionView registerClass:[HHPhotoCollectionViewCell class] forCellWithReuseIdentifier:reuseIdentifier];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    HHPhotoCollectionViewCell *cell = (HHPhotoCollectionViewCell *)[collectionView dequeueReusableCellWithReuseIdentifier:reuseIdentifier forIndexPath:indexPath];
    cell.delegate = self;
...
- (void)collectionView:(UICollectionView *)collectionView willDisplayCell:(UICollectionViewCell *)cell forItemAtIndexPath:(NSIndexPath *)indexPath {
    HHPhotoCollectionViewCell *photoCell = (HHPhotoCollectionViewCell *)cell;
...
- (void)photoCollectionViewCell:(HHPhotoCollectionViewCell *)cell didRequestImage:(UIImage *)image atIndex:(NSInteger)index {
    if (nil == image) return;
...
- (void)photoCollectionViewCell:(HHPhotoCollectionViewCell *)cell didTappedImageForSelected:(BOOL)isSelected atIndex:(NSInteger)index {
