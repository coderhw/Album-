...
#import "HHUnlockViewController.h"
#import <LocalAuthentication/LocalAuthentication.h>

@interface HHUnlockViewController ()<UITextFieldDelegate>

@property (weak, nonatomic) IBOutlet UITextField *passwordTextField;

@end

@implementation HHUnlockViewController
...
- (IBAction)unlockButtonAction:(UIButton *)sender {
    ...
    if (![HHPasswordTool verifyPassword:password]) {
