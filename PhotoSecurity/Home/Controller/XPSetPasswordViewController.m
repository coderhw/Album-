...
@property (weak, nonatomic) IBOutlet UIButton *setPsdButton;
...
- (void)viewDidLoad {
    ...
    [super viewDidLoad];
    [self.setPsdButton setBackgroundImage:[UIImage imageNamed:@"icon_setPsd_btn.png"] forState:UIControlStateNormal];
    [self.setPsdButton setBackgroundImage:[UIImage imageNamed:@"icon_setPsd_btn.png"] forState:UIControlStateHighlighted];

//    self.tipLabel.textColor = [[UIColor alloc] initWithPatternImage:[UIImage imageNamed:@"icon_setPsd_btn.png"]];
    self.setPsdButton.clipsToBounds = YES;
    self.passwordTextField.tintColor = [[UIColor alloc] initWithPatternImage:[UIImage imageNamed:@"icon_setPsd_btn.png"]];
    self.confirmPasswordTextField.tintColor = [[UIColor alloc] initWithPatternImage:[UIImage imageNamed:@"icon_setPsd_btn.png"]];
    
//    self.line1.backgroundColor = [[UIColor alloc] initWithPatternImage:[UIImage imageNamed:@"icon_setPsd_btn.png"]];
//    self.line2.backgroundColor = [[UIColor alloc] initWithPatternImage:[UIImage imageNamed:@"icon_setPsd_btn.png"]];
    
    self.passwordTextField.leftView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"icon_lock_ok.png"]];
    self.passwordTextField.leftViewMode = UITextFieldViewModeAlways;
    
    self.confirmPasswordTextField.leftView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"icon_lock.png"]];
